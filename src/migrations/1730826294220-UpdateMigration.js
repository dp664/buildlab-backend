...
module.exports = class UpdateMigration1730826294220 {
    name = 'UpdateMigration1730826294220'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "student_projects" ADD CONSTRAINT "FK_2f5b0be049c8659345bf152af37" FOREIGN KEY ("student_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "student_projects" ADD CONSTRAINT "FK_f037094b86adb593f0b661042a8" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
